 ...
 *
 * Launch:  EASYAI_SECRETS_FILE=<file> EASYAI_ORCH_RUNNER=memory-approval \
 *          EASYAI_DATA_DIR=<tmp> EASYAI_API_PORT=4406 node apps/api/dist/main.cjs
 * Run:     EASYAI_API_PORT=4406 node scripts/remote-chat.mjs
 */

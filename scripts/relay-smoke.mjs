 ...
 *   EASYAI_SECRETS_FILE=<file> EASYAI_API_PORT=4418 node apps/api/dist/main.cjs
 * Run: EASYAI_API_PORT=4418 node scripts/relay-smoke.mjs
 */
import assert from 'node:assert/strict';
import { RelayServer } from '../apps/gateway/dist/relay/server.js';
import { createGateway } from '../apps/gateway/dist/gateway.js';

const port = process.env.EASYAI_API_PORT || '4418';

...
import type { AgentEvent, ChatRequest } from '@easyai/contracts';
 ...
 * `EASYAI_ORCH_RUNNER=memory-echo|memory-approval`. Never used in production
...
/** Echo-only scripted runner factory (activated via EASYAI_ORCH_RUNNER). */

 ...
 *   EASYAI_SECRETS_FILE=<file> EASYAI_API_PORT=4410 node apps/api/dist/main.cjs
 * Run: EASYAI_API_PORT=4410 node scripts/gateway-stub-smoke.mjs
 */
...
const port = process.env.EASYAI_API_PORT || '4410';

...
function startElectron() {
  electron = run(pnpm, ['exec', 'electron', '.'], { cwd: desktopRoot, env: { ...process.env, EASYAI_RENDERER_URL: 'http://127.0.0.1:5173' } });

 ...
 *
 * Launch api: EASYAI_ORCH_RUNNER=memory-echo EASYAI_DATA_DIR=<tmp>
 *   EASYAI_SECRETS_FILE=<file> EASYAI_API_PORT=4416 node apps/api/dist/main.cjs
 * Run: EASYAI_API_PORT=4416 node scripts/gateway-feishu-smoke.mjs
 */
...
const port = process.env.EASYAI_API_PORT || '4416';

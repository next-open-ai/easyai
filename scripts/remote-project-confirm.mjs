 ...
 * catalog + runtime prefs) and the keyring loaded via EASYAI_SECRETS_FILE,
 ...
 *
 * Launch:  EASYAI_SECRETS_FILE=<file> EASYAI_ORCH_RUNNER=memory-echo \
 *          EASYAI_DATA_DIR=<tmp> EASYAI_API_PORT=4404 node apps/api/dist/main.cjs
 * Run:     EASYAI_API_PORT=4404 node scripts/remote-project-confirm.mjs
 */
